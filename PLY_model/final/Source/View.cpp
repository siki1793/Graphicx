...
void View::renderFunction(){
    ...
    glTranslatef(0.5,-((pl.getyMin()+pl.getyMax())),0.0);
    pv.drawPly();
    glPopMatrix();
...
void View::light(){
    ...
    GLfloat light1_position[] = {-0.75f, 0.0f, 0.0f, 0.0f};
    GLfloat light0_ambient[] =  {102.0/255.0f, 51.0/255.0f, 12.0/255.0f, 0.0f};
    GLfloat light1_ambient[] =  {102.0/255.0f, 51.0/255.0f, 0.0f, 0.0f};
