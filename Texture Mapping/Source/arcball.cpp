...
static float Eye_curr[3]={0.0f,0.0f,2.0f};
...
static void quaternion(GLfloat* q, GLfloat x, GLfloat y, GLfloat z, GLfloat w)
{
  ...
  Eye_curr[0]=q[0]*Eye[0]+q[1]*Eye[1]+q[2]*Eye[2];
  Eye_curr[1]=q[4]*Eye[0]+q[5]*Eye[1]+q[6]*Eye[2];
  Eye_curr[2]=q[8]*Eye[0]+q[9]*Eye[1]+q[10]*Eye[2];
  // Eye_curr[0]=q[0]*Eye_curr[0]+q[1]*Eye_curr[1]+q[2]*Eye_curr[2];
  // Eye_curr[1]=q[4]*Eye_curr[0]+q[5]*Eye_curr[1]+q[6]*Eye_curr[2];
  // Eye_curr[2]=q[8]*Eye_curr[0]+q[9]*Eye_curr[1]+q[10]*Eye_curr[2];
...
static void quatnext(GLfloat* dest, GLfloat* left, GLfloat* right)
{
  ...
  Eye_curr[0]=dest[0]*Eye_curr[0]+dest[1]*Eye_curr[1]+dest[2]*Eye_curr[2];
  Eye_curr[1]=dest[4]*Eye_curr[0]+dest[5]*Eye_curr[1]+dest[6]*Eye_curr[2];
  Eye_curr[2]=dest[8]*Eye_curr[0]+dest[9]*Eye_curr[1]+dest[10]*Eye_curr[2];
}
...
void arcball_move(int mx, int my)
{
  if(ab_planar)
  {
    ...
    vec cross = (ab_start^ab_curr).unit() * sina*2;
...
float vec::getCurrentX()
{
  return Eye_curr[0];
}

float vec::getCurrentY()
{
  return Eye_curr[1];
}

float vec::getCurrentZ()
{
  return Eye_curr[2];
}